...
# spi 0
set_property -dict {PACKAGE_PIN AK17 IOSTANDARD LVCMOS33 PULLUP true} [get_ports spi_csn_0]
...
# spi 1
set_property -dict {PACKAGE_PIN T29 IOSTANDARD LVCMOS33 PULLUP true} [get_ports spi_csn_1]
