...
//    );
  ...
  ad_iobuf #(.DATA_WIDTH(32)) i_iobuf (
    .dio_t ({gpio_t[59], gpio_t[52:46], gpio_t[39:16]}),
    .dio_i ({gpio_o[59], gpio_o[52:46], gpio_o[39:16]}),
    .dio_o ({gpio_i[59], gpio_i[52:46], gpio_i[39:16]}),
...
//              gpio_bd}));       // 14: 0
  ...
  assign gpio_i[58:53] = gpio_o[58:53];
  assign gpio_i[45:40] = gpio_o[45:40];
  assign gpio_i[15:0]  = gpio_o[15:0];


// spi 0 assignments
  assign spi_csn_0    = spi0_csn;
  assign spi_clk_0    = spi0_clk;
  assign spi_mosi_0   = spi0_mosi;
  assign spi_miso_0   = spi0_miso;

// spi 1 assignments
  assign spi_csn_1    = spi1_csn;
  assign spi_clk_1    = spi1_clk;
  assign spi_mosi_1   = spi1_mosi;
  assign spi_miso_1   = spi1_miso;
